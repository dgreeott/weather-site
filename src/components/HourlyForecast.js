                ...
                <div className="col-sm-2">
                  ...
                  <div className="row">
                    <img
                      ...
                      alt={props.hourlyForecast.hourly[0].weather[0].description}
                    />
                  </div>
                </div>
                <div className="col-sm-2">
                  ...
                  <div className="row">
                    <img
                      ...
                      alt={props.hourlyForecast.hourly[1].weather[0].description}
                    />
                  </div>
                </div>
                <div className="col-sm-2">
                  ...
                  <div className="row">
                    <img
                      ...
                      alt={props.hourlyForecast.hourly[2].weather[0].description}
                    />
                  </div>
                </div>
                <div className="col-sm-2">
                  ...
                  <div className="row">
                    <img
                      ...
                      alt={props.hourlyForecast.hourly[3].weather[0].description}
                    />
                  </div>
                </div>
                <div className="col-sm-2">
                  ...
                  <div className="row">
                    <img
                      ...
                      alt={props.hourlyForecast.hourly[4].weather[0].description}
                    />
                  </div>
                </div>
